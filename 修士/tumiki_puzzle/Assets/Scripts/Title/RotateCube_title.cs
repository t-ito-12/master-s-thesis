...
public class RotateCube_title : MonoBehaviour
{
    ...
    void Update()
    {
        _delta.x = _prevX - sliderRotX.value;
		_delta.y = _prevY - sliderRotY.value;
		_prevX = sliderRotX.value;
		_prevY = sliderRotY.value;
